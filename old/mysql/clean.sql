...
SELECT CONCAT('Cleanup trends older than ', @trends_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup trends_uint older than ', @trends_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup Alerts older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup acknowledges older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup events older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup history_str older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup history_log older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup history_text older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup history older than ', @history_interval, ' days') AS ' ';
...
SELECT CONCAT('Cleanup history_uint older than ', @history_interval, ' days') AS ' ';
