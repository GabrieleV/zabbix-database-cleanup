...
SELECT '-- SELECT COUNT(*) FROM maintenances_groups WHERE groupid NOT IN (SELECT groupid FROM groups);' AS ' ';
...
SELECT '-- SELECT COUNT(*) FROM rights WHERE NOT id IN (SELECT groupid FROM groups);' AS ' ';
